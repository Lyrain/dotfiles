...
you should place your code here."
  ...
  (progn ;; Whitespace setup
    ...
    (setq-default
     ;; Set EOL to: ¬ character and show trailing whitespace
     whitespace-style '(face newline-mark)
     ;; end-of-line to not symbol
